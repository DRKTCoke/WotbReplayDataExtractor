...
public final class Columns {
    ...
    public static final List<Col> STAT = List.of(
            ...
            new Col("潜在伤害", "potential_damage", 9, 70, true, p -> p.potentialDamage),
            new Col("补增伤害", "potential_damage_supplement", 9, 70, true, p -> p.potentialDamageSupplement),
            new Col("潜在明细", "potential_damage_detail", 9, 65, false, p -> p.potentialDamageDetailed ? "已解析" : "未解析"),
